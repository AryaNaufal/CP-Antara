      ...
      <div class="blog-content">
        <div class="blog-item-box">
          <div class="row">
            ...
            <!-- End Single Item -->
            <!-- Single Item -->
            <div class="col-lg-4 col-md-6 single-item wow fadeInDown" data-wow-delay="500ms">
              <div class="item">
                <div class="thumb">
                  <a href="#"><img src="assets/img/800x600.png" alt="Thumb"></a>
            ...
            <!-- End Single Item -->
            <!-- Single Item -->
            <div class="col-lg-4 col-md-6 single-item wow fadeInDown" data-wow-delay="800ms">
              <div class="item">
                <div class="thumb">
                  <a href="#"><img src="assets/img/800x600.png" alt="Thumb"></a>
                ...
                <div class="info">
                  ...
                  <h4>
                    <a href="#">Attachment resolution are Pefect shoot in the point</a>
                  </h4>
                  <p>
                    One order all scale sense her gay style wrote. Incommode our not one ourselves residence. Shall there whose those.
                  </p>
            ...
            <div class="col-lg-4 col-md-6 single-item wow fadeInDown" data-wow-defaul="300ms">
              <div class="item">
                <div class="thumb">
                  <a href="#"><img src="assets/img/800x600.png" alt="Thumb"></a>
                  <div class="date"><strong>25</strong> <span>Apr</span></div>
                </div>
                <div class="info">
                  <div class="meta">
                    <ul>
                  ...
                  <h4>
                    <a href="#">Add matter family active mutual put happen. </a>
                  </h4>
                  <p>
                    One order all scale sense her gay style wrote. Incommode our not one ourselves residence. Shall there whose those.
                  </p>
            ...
            <div class="col-lg-4 col-md-6 single-item wow fadeInDown" data-wow-delay="500ms">
              <div class="item">
                ...
                <div class="info">
                  ...
                  <h4>
                    <a href="#">Unsatiable entreaties sympathize nay</a>
                  </h4>
                  <p>
                    One order all scale sense her gay style wrote. Incommode our not one ourselves residence. Shall there whose those.
                  </p>
            ...
            <!-- End Single Item -->
            <!-- Single Item -->
            <div class="col-lg-4 col-md-6 single-item wow fadeInDown" data-wow-delay="1000ms">
              <div class="item">
                <div class="thumb">
                  <a href="#"><img src="assets/img/800x600.png" alt="Thumb"></a>
                  <div class="date"><strong>08</strong> <span>Dec</span></div>
                </div>
                <div class="info">
                  <div class="meta">
                    <ul>
                  ...
                  <h4>
                    <a href="#">Cottage between and way. Minuter own.</a>
                  </h4>
                  <p>
                    One order all scale sense her gay style wrote. Incommode our not one ourselves residence. Shall there whose those.
                  </p>
