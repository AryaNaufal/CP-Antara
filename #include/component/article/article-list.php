<?php
define('ARTICLE_PATH', SERVER_NAME . 'article/');
$articlesPerPage = 6;
                        ...
                        <?php if ($articles !== null && !empty($articles)): ?>
                            ...
                            ?>
                                ...
                                <div class="col-lg-4 col-md-6 single-item wow fadeInDown" data-wow-defaul="300ms">
                                    <div class="item">
                                        <div class="thumb">
                                            <a href="<?= ARTICLE_PATH . $Lib->seoTitle($item['headlines']); ?>">
                                        ...
                                        <div class="info">
                                            <h4
                                                ...
                                                <a href="<?= ARTICLE_PATH . $Lib->seoTitle($item['headlines']); ?>" aria-label="<?= htmlspecialchars($item['headlines']); ?>">
                                            ...
                                            <a class="btn circle btn-theme-border btn-sm" href="<?= ARTICLE_PATH . $Lib->seoTitle($item['headlines']); ?>">
                                                Lihat Selengkapnya
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 pagi-area text-center">
                            <nav aria-label="navigation">
                                <ul class="pagination">
                                    <?php if ($page > 1): ?>
                                        <li class="page-item"><a class="page-link" href="<?= ARTICLE_PATH . ($page - 1); ?>"><i class="fas fa-angle-double-left"></i></a></li>
                                    <?php endif; ?>

                                    <?php if ($totalPages > 1): ?>
                                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                            <li class="page-item <?= ($i == $page || ($i == $totalPages && $page == $totalPages)) ? 'active' : ''; ?>"><a class="page-link" href="<?= ARTICLE_PATH . $i; ?>" aria-label="<?= $i; ?>"><?= $i; ?></a></li>
                                        <?php endfor; ?>
                                    <?php endif; ?>

                                    <?php if ($page < $totalPages): ?>
                                        <li class="page-item"><a class="page-link" href="<?= ARTICLE_PATH . ($page + 1); ?>"><i class="fas fa-angle-double-right"></i></a></li>
                                    <?php endif; ?>
                                </ul>
                            </nav>
                        </div>
