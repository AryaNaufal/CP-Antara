<div class="col-lg-12 services-single-content overflow-hidden">
  ...
  <div class="row gap-5 mx-auto my-5 pb-5 d-flex flex-row-reverse flex-wrap justify-content-center align-items-center">
    ...
    <div class="col-sm-12 col-lg-6">
      <p class="fw-bold fs-5 lh-base">
        Di era digital, informasi dan visual menjadi elemen penting dalam kehidupan.
        <span style="color: var(--color-primary);">Antara Foto</span>,
  ...
  <div class="row gap-5 mx-auto my-5 py-5 d-flex justify-content-center align-items-center">
    ...
    <div class="col-sm-12 col-lg-6 d-flex flex-wrap">
      <h1 class="fw-bolder fs-2" style="color: var(--color-primary);">Jutaan Foto Berkualitas Tinggi</h1>
      <p>
        <span class="fw-bold" style="color: var(--color-primary);">Antara Foto</span>
  ...
  <div class="row gap-5 mx-auto my-5 py-5 d-flex flex-row-reverse flex-wrap justify-content-center align-items-center">
    ...
    <div class="col-sm-12 col-lg-6">
      <h1 class="fw-bolder fs-2" style="color: var(--color-primary);">Arsip Foto Terlengkap di Indonesia</h1>
      <p>
  ...
  <div class="row gap-5 mx-auto my-5 py-5 d-flex justify-content-center align-items-center">
    ...
    <div class="col-sm-12 col-lg-6 d-flex flex-wrap">
      <h1 class="fw-bolder fs-2" style="color: var(--color-primary);">Inspirasi Tak Terbatas untuk Kreativitas Anda</h1>
      <p>
  ...
  <div class="row gap-5 mx-auto my-5 py-5 d-flex flex-row-reverse flex-wrap justify-content-center align-items-center">
    ...
    <div class="col-sm-12 col-lg-6">
      <h1 class="fw-bolder fs-2" style="color: var(--color-primary); ">Antara Foto: Solusi Lengkap untuk Kebutuhan Visual Anda</h1>
      <p>
        Bergabunglah dengan
        <span class="fw-bold" style="color: var(--color-primary);">Antara Foto</span>
        dengan mengunjungi
        <span class="fw-bold" style="color: var(--color-primary);"><a href="https://www.antarafoto.com/" target="_blank">www.antarafoto.com </a></span>
