...
<section class="default-padding-top default-padding bg-gray" id="product">
    <div class="site-heading text-center wow fadeInDown">
        <h2 class="fs-4">Syarat dan Ketentuan Akses dan Penggunaan</h2>
    ...
    <div class="container">
        <div class="pb-3 px-3">
            <p class="fs-6" style="font-weight: 500;">
                <span>
                    HARAP MEMBACA SYARAT DAN KETENTUAN INI DENGAN SEKSAMA
                </span>
                - DENGAN MELIHAT SITUS WEB IMCS.COM, ANDA SETUJU UNTUK TERIKAT OLEH SYARAT DAN KETENTUAN BERIKUT ("PERSYARATAN"). JIKA ANDA TIDAK MENERIMA PERSYARATAN INI, SILAHKAN MENGHENTIKAN AKSES ANDA KE SITUS. KAMI SETIAP SAAT DAPAT MEREVISI PERSYARATAN INI DENGAN MEMPERBARUI VERSI INI UNTUK MENCERMINKAN PERUBAHAN DALAM KEGIATAN KAMI. KAMI MENGHIMBAU ANDA UNTUK MENGUNJUNGI HALAMAN WEB INI SECARA BERKALA UNTUK MENGETAHUI PERUBAHAN APA PUN TERHADAP PERSYARATAN INI.
            </p>
        </div>
        <ol class="fs-6 lh-lg">
